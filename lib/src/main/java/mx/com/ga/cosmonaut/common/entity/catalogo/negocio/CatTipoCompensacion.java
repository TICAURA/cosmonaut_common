...
@Data
@MappedEntity(value = "cat_tipo_compensacion")
public class CatTipoCompensacion implements Serializable {

    private static final long serialVersionUID = 1L;
    @Id
    @GeneratedValue(GeneratedValue.Type.IDENTITY)
    @MappedProperty(value = "tipo_compensacion_id")
    private Long tipoCompensacionId;
    ...
    @Relation(value = Relation.Kind.ONE_TO_MANY, mappedBy = "tipoCompensacionId")
    private List<NcoContratoColaborador> ncoContratoColaboradorList;
