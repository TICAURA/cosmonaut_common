...
@Data
@MappedEntity(value = "cat_tipo_preferencia")
public class CatTipoPreferencia implements Serializable {
    ...
    @Relation(value = Relation.Kind.ONE_TO_MANY, mappedBy = "tipoPreferenciaId")
    private List<NcoPreferencia> ncoPreferenciaList;
